 ...
 * @returns filename
 */
var downloadYTAndSave = function (url_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([url_1], args_1, true), void 0, function (url, filename) {
        var audio, err_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, fs_extra_1.writeFile)(filename, new Uint8Array(audio))];
                case 3:
                    _a.sent();
